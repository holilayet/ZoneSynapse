...
#[derive(Debug)]
pub struct ZoneSynapseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ZoneSynapseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ZoneSynapse processing");
    
    let mut processor = ZoneSynapseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ZoneSynapseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ZoneSynapseProcessor::new(false);
